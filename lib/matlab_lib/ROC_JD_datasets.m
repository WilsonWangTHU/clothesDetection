...
function [number_gt, number_pst_detection, ...
    ...
    plot_for_each_category, multi_label_test)
...
for i_category = 1: 1: number_category
    ...
    while tline ~= -1
        ...
        if multi_label_test
            ...
            gt_multi_attributive = find(multi_label_class == 1);
            % get the predicted id
            for ibox = 1: 1: 10
                [max_texture_cfd, max_texture_Id] = ...
                    max(results(10 * i_image - 9: 10 * i_image, ...
                    6 : 6 + attr_length(1) - 1));
                ...
                [max_sleeve_cfd, max_sleeve_Id] = ...
                    ...
                    6 + attr_length(1) + attr_length(2) ...
                    + attr_length(3)));
                max_sleeve_Id = max_sleeve_Id + attr_length(1) + attr_length(2);
            end
            [sgl_number_gt_atti, sgl_number_pst_detection_atti, ...
                sgl_number_detection_atti, sgl_number_recall_atti] = ...
                attributive_test(gt_position, gt_multi_attributive, ...
                predict_proposals, ...
                [max_texture_cfd, max_texture_Id; ...
                max_neckband_cfd, max_neckband_Id; ...
                max_sleeve_cfd, max_sleeve_Id], ...
