...
_V1LAYERPARAMETER_LAYERTYPE = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='MULTI_LABEL_ACCURACY', index=40, number=36,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='MULTI_LABEL_LOSS', index=41, number=37,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_ROIPOOLINGPARAMETER = descriptor.Descriptor(
...
class ROIPoolingParameter(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
