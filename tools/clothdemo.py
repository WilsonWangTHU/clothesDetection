...
# -----------------------------------------------------------
# it is a test by applying the fast rcnn on the cloth dataset
# 2015.5.7 test some random pictures
...
def parse_args():
    ...
    parser.add_argument('--netModel', dest='caffemodel', help='modelName',
                        default='\home\wtw\123.jpg', type=str)
    parser.add_argument('--prototxt', dest='prototxt', help='proto_txt_name',
                        default='\home\wtw\123.jpg', type=str)
